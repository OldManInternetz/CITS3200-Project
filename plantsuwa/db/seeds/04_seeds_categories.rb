...
@strappy = Type.create(name: 'Strappy')
...
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Acacia iteaphylla')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Acacia lasiocarpa')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Acacia pulchella')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Acacia rostellifera')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Acacia truncata (incomplete)')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Acacia xanthina')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Acanthus mollis')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Acmena smithii')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Adenanthos cygnorum')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Adenanthos sericeus')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Agapanthus praecox')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Agonis flexuosa')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Agonis flexuosa \'nana\'')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Agonis linearifolia')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Ajuga reptans')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Allocasuarina fraseriana')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Andersonia gregoria')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Anigozanthos flavidus')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Anigozanthos manglesii')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Anigozanthos viridus')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Aptenia cordifolia')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Araucaria heterophylla')
@conifer.current_plants << CurrentPlant.find_by_scientific_name('Arctotis x hybrida')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Aspidistra elatior')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Asplenium australasicum')
@fern.current_plants << CurrentPlant.find_by_scientific_name('Astartea fascicularis')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Baeckea camphorosmae')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Baeckea virgata (inc)')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Banksia ashbyi')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Banksia attenuata')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Banksia baxteri (inc)')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Banksia blechnifolia (incomplete)')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Banksia coccinea')
...
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Banksia grandis')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Banksia hookeriana')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Banksia ilicifolia')
...
@tree.current_plants << CurrentPlant.find_by_scientific_name('Banksia petiolaris')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Banksia prionotes')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Banksia victoriae')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Baumea articulata')
@sedge.current_plants << CurrentPlant.find_by_scientific_name('Baumea juncea')
@sedge.current_plants << CurrentPlant.find_by_scientific_name('Beaufortia squarrosa')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Begonia')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Boronia heterophylla')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Bougainvillea glabra')
@climber.current_plants << CurrentPlant.find_by_scientific_name('Brachychiton acerifolius')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Brachychiton discolour')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Brachyscome iberidifolia')
...
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Callistemon Little John')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Callistemon phoeniceus')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Callistemon viminalis')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Callitris preissii')
@conifer.current_plants << CurrentPlant.find_by_scientific_name('Calodendron capense')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Calothamnus hirsutus')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Carpobrotus')
@succulent.current_plants << CurrentPlant.find_by_scientific_name('Carpobrotus virescens')
@succulent.current_plants << CurrentPlant.find_by_scientific_name('Casuarina cunninghamiana')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Casuarina equisetifolia')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Casuarina obesa')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Ceratoptalum gummiferum')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Chamelaucium uncinatum')
...
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Cinnamomum camphora')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Clematis microphylla')
@climber.current_plants << CurrentPlant.find_by_scientific_name('Clivia miniata')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Coleonema pulchrum')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Conospermum stoechadis')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Conostylis candicans')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Convolvulus sabatius')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Coprosma repens')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Cordyline australis (inc)')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Cordyline indivisa')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Correa alba')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Correa reflexa')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Corymbia calophylla')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Corymbia citriodora')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Corymbia ficifolia')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Corymbia maculata')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Crinum pedunculatum')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Cupressus sempervirens')
@conifer.current_plants << CurrentPlant.find_by_scientific_name('Cyathea cooperi')
@fern.current_plants << CurrentPlant.find_by_scientific_name('Cycad thouarsi')
@grass.current_plants << CurrentPlant.find_by_scientific_name('Cynodon dactylon')
@grass.current_plants << CurrentPlant.find_by_scientific_name('Dampiera linearis')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Darwinia citriodora')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Delonix regia')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Dianella revoluta')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Dichondra repens')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Dietes bicolor')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Dietes grandiflora')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Dietes iridioides')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Dodonea viscosa purpurea')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Dryandra nivea')
...
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Eremophila ?')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Eremophila nivea')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Erythrina indica')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Eucalyptus caesia')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Eucalyptus camaldulensis')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Eucalyptus cladocalyx')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Eucalyptus erythrocorys')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Eucalyptus foecunda')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Eucalyptus gomphocephala')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Eucalyptus Lemanii')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Eucalyptus macrocarpa')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Eucalyptus marginata')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Eucalyptus rudis')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Eucalyptus sideroxylon')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Eucalyptus tetragona (incomplete)')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Eucalyptus torquata')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Eucalyptus utilis')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Eucalyptus wandoo')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Euryops pectinatus')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Ficinia nodosa')
@sedge.current_plants << CurrentPlant.find_by_scientific_name('Ficus')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Ficus microcarpa var. hillii (incomplete)')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Ficus pumila')
@climber.current_plants << CurrentPlant.find_by_scientific_name('Ficus rubiginosa')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Fraxinus excelsior (Incomplete)')
...
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Ginkgo biloba')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Gleditsia tricanthos')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Golden Cane Palm')
...
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Grevillea leucopteris [incomplete]')
...
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Grevillea robusta')
...
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Grewia occidentalis')
...
@tree.current_plants << CurrentPlant.find_by_scientific_name('Hakea petiolaris')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Hardenbergia comptoniana')
@climber.current_plants << CurrentPlant.find_by_scientific_name('Hedera canariensis')
@climber.current_plants << CurrentPlant.find_by_scientific_name('Hedera helix')
@climber.current_plants << CurrentPlant.find_by_scientific_name('Helichrysum ramosissimum (incomplete)')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Hemiandra pungens')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Hibbertia cuneiformis')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Hibbertia huegelii')
@climber.current_plants << CurrentPlant.find_by_scientific_name('Hibiscus')
...
@palm.current_plants << CurrentPlant.find_by_scientific_name('Howea forsteriana (incomplete)')
@palm.current_plants << CurrentPlant.find_by_scientific_name('Hymenosporum flavum')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Hypocalyma')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Isopogon')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Juncus karusii (incomplete)')
@sedge.current_plants << CurrentPlant.find_by_scientific_name('Juncus pallidus')
@sedge.current_plants << CurrentPlant.find_by_scientific_name('Kingia australis')
...
@sedge.current_plants << CurrentPlant.find_by_scientific_name('Leucophyta brownii')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Leucospermum')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Livistonia australis (incomplete)')
@palm.current_plants << CurrentPlant.find_by_scientific_name('Lobelia alata')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Lomandra longifolia')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Lophostemon confertus')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Macadamia tetraphylla (incomplete)')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Macropidia fuliginosa (incomplete)')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Maireana oppositifolia')
@climber.current_plants << CurrentPlant.find_by_scientific_name('Melaleuca')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Melaleuca huegelii')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Melaleuca lanceolata')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Melaleuca leucadendra')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Melaleuca nesophila')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Melaleuca pentagona')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Melaleuca quinquenervia')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Melaleuca rhaphiophylla')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Melaleuca viridiflora (incomplete)')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Melia azedarach var. australasica (incomplete)')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Murraya paniculata')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Myoporum parvifolium')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Nerium oleander cv pink Surprise')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Pandanas')
@climber.current_plants << CurrentPlant.find_by_scientific_name('Parthenocissus tricuspidata (incomplete)')
@climber.current_plants << CurrentPlant.find_by_scientific_name('Pelargonium')
@palm.current_plants << CurrentPlant.find_by_scientific_name('Phoenix roebelenii')
@palm.current_plants << CurrentPlant.find_by_scientific_name('Pilots exaltatus')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Pittosporum phylliraeoides (incomplete)')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Pittosporum rhombifolium (incomplete)')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Plantanus x acerfolia')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Plumeria')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Raphiolepis cv Apple Blossum')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Regalia?')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Robinia pseudoacacia')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Sapium sebiferum (incomplete)')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Scaevola \'Purple Fanfare\' (incomplete)')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Scaevola crassifolia')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Scaffold aneura')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Spinifex hirsutus')
@tree.current_plants << CurrentPlant.find_by_scientific_name('Tecoma alata')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Templetonia retusa')
...
@tree.current_plants << CurrentPlant.find_by_scientific_name('Unknown 2')
@herbaceous_shrub.current_plants << CurrentPlant.find_by_scientific_name('Viola hederacea')
@woodyshrub.current_plants << CurrentPlant.find_by_scientific_name('Westringia fruiticosa')
