...
CurrentPlant.create(name: '', common_name: '', family: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'zzz?')
CurrentPlant.create(name: '', common_name: '', family: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'zzzA')
