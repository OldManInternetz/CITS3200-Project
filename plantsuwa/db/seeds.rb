...
User.create(username: 'Paul', password: 'password', password_confirmation: 'password', email: 'paul@madmen.com', admin: 'false', trusted: 'false')
...
leaf_colours = LeafColour.create([
  {name: 'Green'}, 
  {name: 'Dark Green'}, 
  {name: 'Grey-Green', alt_colour: '#486649'}, 
  {name: 'Grey'}, 
  {name: 'Silver'}
])
...
CurrentPlant.create(name: '', common_name: '', family: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Hake')
CurrentPlant.create(name: '', common_name: '', family: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Hake')
