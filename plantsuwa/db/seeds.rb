...
CurrentPlant.create(name: 'Aniseed boronia', common_name: 'Aniseed boronia', description: 'dainty slightly pendulous small aromatic shrub
...
Frost Tolerant', scientific_name: 'Boronia crenulata') 
 CurrentPlant.create(name: 'Ashby\'s Banksia', common_name: 'Ashby\'s Banksia, Orange banksia, Sunrise', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: 'Medium to tall shrub with saw toothed green leaves. Terminal bright orange-yellow flower heads up to 20 cm long.', physical:'- Attractive, toothed, green foliage.
...
', scientific_name: 'Macropidia fuliginosa (incomplete)') 
 ...
 \'Frisia\' Golden Robinia - golden leaf form', description: 'Tree 15 m. Potentially weedy. Can produce magnificent displays of dense white flowers over the tree.', synonym: '', subspecies: '', location_name: 'North of Ocagon Theatre', general_info: 'Prefers light sandy soils. Grows naturally in woodland thickets in the USA', additional_info: 'robinia - after Jean Robin the herbalist to Henry IV and Louis XIII of France. IN 1600\'s his sone intreoduced the tree to Europe, now naturalised over UK and Europe. pseudoacacia - false acacia- due to pinate leaves', identification: 'Pinate leaves 30 cm long with 13-15 yellowish-green ovate leaflets. Branches twisting. Deeply furrowed bark on bole. White pea-shaped flowers in long (ca 13 cm), dense sprays.', physical:'- Attractive, irritating, Pinate 13-15 cm long, leaflets ovate, light green foliage.
...
- Prefers all types soils, with a neutral pH.', scientific_name: 'Robinia pseudoacacia') 
 CurrentPlant.create(name: 'Blue lechenaultia', common_name: 'Blue lechenaultia', description: 'Stunning blue flowers.', synonym: '', subspecies: '', location_name: '', general_info: 'Drought tolerant. Frost tolerant to -5C. Likes heavy/clay soil or well drained soil with few phosphates and nitrates.', additional_info: '', identification: 'Small open shrub with brilliant blue flowers', physical:'- Blue-green, small, linear, heath-like, green foliage.
...
CurrentPlant.create(name: 'Boab', common_name: 'Boab', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Andersonia gregoria')
 CurrentPlant.create(name: 'Brighteyes', common_name: 'Brighteyes, Resin bush, Yellow daisy', description: '', synonym: '', subspecies: '', location_name: 'Taxonomic garden', general_info: 'preferring partial shade in hot environments. Favouring a moist gravelly soil.', additional_info: '', identification: 'Leaves are deeply cut, grey-green. Floral head is bright yellow, daisy-like (made up of numerous individual flowers).', physical:'- Deeply cut grey-, green foliage.
...
- Frost Tolerant', scientific_name: 'Euryops pectinatus') 
 CurrentPlant.create(name: 'Broad-leaved paperbark', common_name: 'Broad-leaved paperbark', description: 'Paperbark. Useful alternate to M. quinquinerva - with green or red flowers. Note: The related M. quinquinerva is weedy in wetland areas - Everglades in Florida.', synonym: '', subspecies: '', location_name: 'oondalup- Central Park', general_info: 'Requires water during establishment and access to irrigation of groundwater during summer.', additional_info: 'viridflora- means green flowers, but better known for the red-flowered form', identification: 'Tall paperbark tree 15-20 m, shorter and more shrubby than M. quinquinerva. Broadly eliptic leaves with 5 main longitudinal veins visible on leaves. Large green or red bottlebrush-type flowers.', physical:'- Attractive, 4-8 x 1.5-3 cm broadly-elliptic, 5 veins, green foliage.
...
- Salt Tolerant', scientific_name: 'Melaleuca quinquenervia') 
 CurrentPlant.create(name: 'Brush Box', common_name: 'Brush Box, Queensland Box', description: 'Do not plant this species as street trees, especially under powerlines. Variegated forms are available e.g. \'Perth Gold\' - gold and green variegated foliage with gold at the margins, \'Variegatus\' has cream/white and green variegated leaves with green at the margins.
...
CurrentPlant.create(name: 'Bush lily', common_name: 'Bush lily', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: 'Plant with crow above soil 30 cm apart. Water well. Temp range 15- 25C.', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: 'Strappy leaves height 45cm', environment: 'Needs shade in Perth. Not frost tolerant.', scientific_name: 'Clivia miniata')
 CurrentPlant.create(name: 'Butterbush', common_name: 'Butterbush, Weeping Pittosporum', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'- Attractive, Narrow linear, aromatic, green foliage.
...
CurrentPlant.create(name: 'Cabbage Plam', common_name: 'Cabbage Plam', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: 'Palm, palm 6 - 12m.', environment: '', scientific_name: 'Livistonia australis (incomplete)')
 CurrentPlant.create(name: 'Camphor myrtle', common_name: 'Camphor myrtle, Heath-myrtle', description: 'Aromatic, low spreading shrub, long flowering, summer flowering. This native blends well with exotics.', synonym: '', subspecies: '', location_name: '', general_info: 'Found growing naturally on rocky slopes and foothills on heavier soils. Likes moist soil, tolerates periods of temporary inundation', additional_info: 'Plants are commonly referred to as \'Heath-myrtle\', a reference to their \'heath-like\' foliage, the prefix \'Camphor\' being a reference to the smell emitted on crushing of the foliage.
...
- Prefers loam, well drained soils', scientific_name: 'Cinnamomum camphora') 
 CurrentPlant.create(name: 'Canary Island date palm', common_name: 'Canary Island date palm', description: '', synonym: '', subspecies: '', location_name: 'Great Court - outside Geology', general_info: '', additional_info: '', identification: 'Dioecious plant (separate male and female trees).
...
- Prefers loam, well drained soils.', scientific_name: 'Sapium sebiferum (incomplete)') 
 CurrentPlant.create(name: 'Claret Ash', common_name: 'Claret Ash', description: 'Large elegant tree. Dense dark green foliage in spring and summer. Deep reddish-purple coloured leaves in autumn. Has good autumn colour in Perth.
...
- Salt Tolerant', scientific_name: 'Eucalyptus utilis') 
 CurrentPlant.create(name: 'Coastal Rosemary', common_name: 'Coastal Rosemary', description: 'Coastal - tolerates harsh winds and salt spray. Rounded dense shrub. Fast growing.
...
CurrentPlant.create(name: 'Cockies Tongue', common_name: 'Cockies Tongue, Coral bush', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: 'woody shrub 1 - 2 m.', environment: '', scientific_name: 'Templetonia retusa')
...
Frost Tolerant', scientific_name: 'Correa reflexa') 
 CurrentPlant.create(name: 'Common dampiera', common_name: 'Common dampiera', description: 'attractive blue-purple flowering rockery plant', synonym: 'D. cuneata', subspecies: '', location_name: '', general_info: 'will tolerate periods of dryness,', additional_info: 'The name \'Common dampiera\' is Western Australian.
...
', scientific_name: 'Conospermum stoechadis') 
 CurrentPlant.create(name: 'Common woolly bush', common_name: 'Common woolly bush', description: '', synonym: '', subspecies: '', location_name: 'taxonomic garden', general_info: 'Naturally growing on sandy soils in the Perth region (being most common on the Bassendean sands) and on the lateritic soils on the Darling Plateau.', additional_info: 'cygnus is Latin for \'swan\' and refers to its association with the Swan River (Western Australia).
...
- Frost Tolerant', scientific_name: 'Acacia saligna') 
 CurrentPlant.create(name: 'Coral gum', common_name: 'Coral gum, Coolgardie gum, Coolgardie rose, Coral-flowered gum', description: 'One of the most popular small eucalypts in cultivation. Long flowering, drought resistant. Cut flowers, buds and fruit may be used in dried floral arrangements. Blossoms when very young.
...
', environment: '- Full sun', scientific_name: 'Cynodon dactylon') 
 CurrentPlant.create(name: 'Couch honeypot', common_name: 'Couch honeypot, Budjarn', description: 'golden brown rounded flower heads displayed in winter and spring', synonym: '', subspecies: '', location_name: 'UWA Campus: Taxonomic garden', general_info: 'naturally growing on sandy or gravelly soils.', additional_info: 'Budjarn is the name given to this plant by south-west Western Australian Aborigines.
...
Frost Tolerant', scientific_name: 'Hibbertia cuneiformis') 
 CurrentPlant.create(name: 'Devil\'s pins', common_name: 'Devil\'s pins', description: 'attractive purple pea-shaped flowers produced in late winter and spring.', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: 'Extends from Mt Lesueur to Perth, Albany to Esperance, inland at Coolgardie.', identification: 'Reaching 1-1.5m tall (note, often taller in its native habitat).
...
- Wind Tolerant', scientific_name: 'Acacia lasiocarpa') 
 CurrentPlant.create(name: 'Dwarf peppermint', common_name: 'Dwarf peppermint', description: 'Attractive hedge plant, with new foliage being red tinged.', synonym: '', subspecies: '', location_name: 'Sunken garden, Biological Sciences Library, Agriculture Garden', general_info: 'hardy plant growing in most soil types, preferring organically enriched soil which have better water retention properties.', additional_info: 'flexuosa is Latin for \'bent\' and describes the zigzag pattern of branches. \'nana\' being Latin for dwarf, and refers to the small habit of the plant. A. flexuosa is commonly known as \'Peppermint Tree\', Peppermint describing the fragrance of the leaves when crushed. This cultivar extends its name with the prefix \'dwarf\' making it known as \'Dwarf peppermint\'.
...
Wind Tolerant', scientific_name: 'Melaleuca pentagona') 
 CurrentPlant.create(name: 'English Ivy', common_name: 'English Ivy, Common Ivy', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: 'ABC Gardening Australia \'Flora\' Encyclopaedia Botanica', identification: 'Multiple varieties', physical:'- 3-5 lobed, 4-6 cm. Adult - unlobed, dark green foliage.
...
', scientific_name: 'Hedera helix') 
 CurrentPlant.create(name: 'Fiery bottlebrush', common_name: 'Fiery bottlebrush, Western bottlebrush, Toobada, Lesser bottlebrush', description: 'blue / grey green foliage contrasts well with the bright red floral spikes produced in spring - early summer, blends well with exotics.', synonym: '', subspecies: '', location_name: '', general_info: 'naturally growing on sandy heathlands, along stream lines and coastal swamp margins. Tolerates wet soil and temporary inundation.', additional_info: 'The specific name of phoeniceus is Latin for \'from Phoenicia\', and refers to the country of origin, now Lebanon, of ancient crimson-purple dyes. The colour of which is seen on the bottlebrush flowers of this species.
...
', scientific_name: 'Brachychiton acerifolius') 
 CurrentPlant.create(name: 'Flinders Range wattle', common_name: 'Flinders Range wattle, Willow-leafed wattle, Port Lincoln wattle', description: 'beautiful dense weeping shrub, with attractive blue-green foliage, perfumed yellow flowers (long flowering) and decorative silvery pods. A good native to blend with exotics.', synonym: '', subspecies: '', location_name: 'Sunken Garden, Agriculture - soil science courtyard, Botany - courtyard', general_info: 'will grow on most soil types', additional_info: 'iteaphylla is Greek for \'willow leafed\', describing the weeping soft foliage which resembles that of willows.
...
CurrentPlant.create(name: 'Foxtail mulga grass', common_name: 'Foxtail mulga grass', description: 'Tufted perennial grass-like herb. Rhizomatous. Flowers green grey with white hairs.', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Neurachne alopecuroides')
 CurrentPlant.create(name: 'Freshwater paperbark', common_name: 'Freshwater paperbark, Swamp paperbark', description: 'Good wetland plant, drier end of littoral zone.', synonym: '', subspecies: '', location_name: '', general_info: 'It is found naturally growing near watercourses and wetlands (at the drier end of the littoral zone). It is able to tolerate periods (several months) of inundation, prefering waterlogged sites. Growing near both fresh and saline water, being less adapted to saline water than M. cuticularis.', additional_info: 'Greek rhaphis meaning \'needle\' and phyllon meaning \'leaf\', referring to the shape of the leaves. 
...
cv Purple Pride', description: 'Large shrub 2 x 2 m. Attractive habit, profuse display of white, pink or purple flowers. Great cut flowers.
...
- Wind Tolerant', scientific_name: 'Grevillea obtusifolia') 
 CurrentPlant.create(name: 'Green kangaroo paw', common_name: 'Green kangaroo paw', description: 'Bright green flowers are eye catching and contrast well with red-pink coloured forms.', synonym: '', subspecies: '', location_name: '', general_info: 'Will tolerant winter-damp soils (tolerating moister conditions than any other kangaroo paw). Naturally found in low-lying sandy depressions which are waterlogged in winter. Requires water. Found growing on the coastal plain.', additional_info: 'Named by Stephan L. Endlicher, Professor of Botany and Director of the \'Botanical Gardens in Vienna\' in Germany in 1846. 
...
', scientific_name: 'Doryanthes excelsa(inc)') 
 CurrentPlant.create(name: 'Heart-leaved flame pea', common_name: 'Heart-leaved flame pea, Heart-leafed flame pea, Flame pea', description: 'spectacular sprays of bright orange-red pea flowers produced in spring. This native blends well with exotics.', synonym: '', subspecies: '', location_name: 'Agriculture garden', general_info: 'Suited to most soils as long as they are well draining. Best in a sandy loam. Likes regular watering (water in dry winters). Tolerates heavy shade.', additional_info: 'The specific name of cordatum is derived from the Latin cordata meaning \'heart-shaped\' and refers to the heart-shaped leaf base. Commonly referred to as \'Flame peas\' due to the brilliant colours of the flowers.
...
- Salt Tolerant', scientific_name: 'Casuarina equisetifolia') 
 CurrentPlant.create(name: 'Illyarrie', common_name: 'Illyarrie, Red-capped gum, Bookara gum', description: 'Interesting small to medium tree with vibrant red bud-caps, attractive yellow flowers and urn-shaped fruits. It is commonly used in dried floral arrangements.', synonym: '', subspecies: '', location_name: 'Recreation Centre carpark, Tax garden', general_info: 'Illyarrie although naturally restricted to coastal limestone soils is adaptable to a wider range of soil types ranging from clay and granitic loams to coastal sands.', additional_info: 'From the Greek erythros meaning \'red\' and corys meaning \'helmet\', which refers to the red bud cap. 
...
- Frost Tolerant', scientific_name: 'Cupressus sempervirens') 
 CurrentPlant.create(name: 'Jacaranda', common_name: 'Jacaranda', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: 'Bipinnate leaves. Mauve flowers in summer. Round pods 10 cm. Deciduous.', physical:'Attractive, Bipinnate, 30 cm long foliage.
', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: 'Medium sized tree 8-15 m, 6-10 m, tree 6 - 12m. With a open canopy.', environment: '', scientific_name: 'Jacaranda mimosifolia') 
 CurrentPlant.create(name: 'Japanese Ivy', common_name: 'Japanese Ivy, Boston Ivy', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: 'Three cusps (points) on leaves', physical:'- Attractive, three lobed leaf, green foliage.
...
- Frost Tolerant', scientific_name: 'Dichondra repens') 
 CurrentPlant.create(name: 'Kingia', common_name: 'Kingia, Bullanock, Black gin', description: 'Beautiful ornamental tree, very slow growing, not able to be transplanted as mature adults.', synonym: '', subspecies: '', location_name: '', general_info: 'Found predominantly on the clayey flats on the eastern side of the coastal plain, and has been seen growing in selected sites on the Darling Scarp. Habitat is generally sandy loam and clay loam with a preference for more swampy conditions or areas with a high water table.', additional_info: 'australis is Latin for \'southern\', and refers either to \'the southern hemisphere\' or the \'southern-part\' of the Australian continent.
...
Frost Tolerant', scientific_name: 'Darwinia citriodora') 
 CurrentPlant.create(name: 'Lemon-scented gum', common_name: 'Lemon-scented gum, Lemon-scented spotted gum', description: 'tall beautiful attractive tree', synonym: 'E. citriodora', subspecies: '', location_name: '', general_info: 'Will grow in a variety of soils, prefering medium to sandy loams or well drained gravels where additional irrigation is available during dry times. Will tolerate cold clay soils that are poorly drained, but not boggy or stagnant in winter, and usually dry out in summer. Known to tolerate dry or wet conditions, but not severe frosts.', additional_info: 'latin citri meaning \'lemon\', odorus meaning \'having a smell\', referring to the lemon scented foliage. 
...
- Frost Tolerant', scientific_name: 'Acmena smithii') 
 CurrentPlant.create(name: 'Liquidamber', common_name: 'Liquidamber, Sweetgum', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: 'Liquidamber refers to the bright autumn foliage', identification: '5-pointed leaves.', physical:'Attractive, 5 pointed leaves, green foliage.
...
- Frost Tolerant', scientific_name: 'Plantanus x acerfolia') 
 CurrentPlant.create(name: 'macadamia', common_name: 'macadamia, Queensland Nut, Bopple Nut', description: '', synonym: '', subspecies: '', location_name: 'Tropical Grove - behind Stewart seat', general_info: '', additional_info: 'Inf from ABC Gardening Australia \'Flora\' Encyclopaedia Botanica', identification: '3-leafed whorls, glossy sessile leaves', physical:'- Attractive, irritating, undulating, serrate margins in 3s. sessile, dark green foliage.
...
', description: 'Grown for its attractive autumn foliage (turning yellow and falling).', synonym: 'Salisburia adiantifolia', subspecies: '', location_name: 'Great Court', general_info: 'tolerates a wide range of environmental conditions from arid to wet climates. Requires deep fertile, moist soil. Previously growing on mostly alluvial soil.', additional_info: 'biloba is derived from Latin and means \'leaves with 2 lobes\', a distinguishing feature of this tree.
...
- Salt Tolerant', scientific_name: 'Ficus macrophylla') 
 CurrentPlant.create(name: 'Moroccan glory vine', common_name: 'Moroccan glory vine, Bindweed', description: 'attractive mauve-blue flowers are produced from spring to autumn', synonym: 'C. mauritanicus', subspecies: '', location_name: 'Sunken garden', general_info: '', additional_info: '', identification: 'Slender stemmed. Leaves are small and oval shaped. Trumpet-shaped flowers are blue-purple , borne from spring to autumn.', physical:'- Small oval, green foliage.
...
CurrentPlant.create(name: 'Mulla mulls', common_name: 'Mulla mulls', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Pilots exaltatus')
 CurrentPlant.create(name: 'Native frangipani', common_name: 'Native frangipani, Australian frangipani, Sweetshade, Wing-seed tree', description: 'attractive small slender tree, with showy white-yellow, perfumed flowers. This native blends well with exotics.', synonym: '', subspecies: '', location_name: 'Agriculture garden', general_info: 'Naturally growing in rainforest habitats, in coastal gullies and along the fringes of forests. Likes fertile, moist, composted or humus rich soil. Tolerates temporary inudation.', additional_info: 'flavum being Latin for \'yellow\' and refers to the mature flower colour.', identification: 'This small slender tree is columnar shaped, becoming triangular with maturity. Branches are sparse and often downturned, giving this tree an attractive horizontal layered look.
...
- Frost Tolerant', scientific_name: 'Clematis microphylla') 
 CurrentPlant.create(name: 'Old socks', common_name: 'Old socks, White Plume Grevillea', description: '', synonym: '', subspecies: '', location_name: 'WA between lower Murchison River and Marchagee', general_info: '', additional_info: 'Whitish wing surrounding the seed , from the Greek, leucon [white]and pteron[a wing]', identification: 'dense shrub with emergent floral branches', physical:'- Attractive, winged, grey green,, pungent, light green foliage.
...
Frost Tolerant', scientific_name: 'Dryandra sessilis') 
 CurrentPlant.create(name: 'Peppermint tree', common_name: 'Peppermint tree, Willow myrtle, Wonnil, Peppermint', description: 'Attractive weeping foliage, blends well with exotics.', synonym: '', subspecies: '', location_name: 'Sunken garden', general_info: 'Naturally found on coastal dune systems, limestone heath and sandy soils. Commonly growing as an understorey tree in tall tuart (E. gomphocephala) forests. Preferring friable organically rich soil, to improve water retention. Hardy and being able to grow in most soil types, including sandy soils.', additional_info: 'flexuosa is Latin for \'bent\' or \'full of bends\' and describes the zig-zag pattern of branches, which change direction at each leaf node. The common name of Peppermint was thought to aptly describe the fragrance of the leaves when crushed.
...
- Frost Tolerant', scientific_name: 'Hakea laurina') 
 CurrentPlant.create(name: 'Pink riceflower', common_name: 'Pink riceflower', description: 'Stunning floral display in spring. Compact shrub.
...
Salt Tolerant', scientific_name: 'Pimelea ferruginea') 
 CurrentPlant.create(name: 'Pink-flowering iron bark', common_name: 'Pink-flowering iron bark, Mugga ironbark, Red ironbark, Mugga', description: 'Highly ornamental tree, long flowering, reasonably slow growing, best of the ironbarks. Grey-green soft foliage attractive against the black bark.
...
CurrentPlant.create(name: 'Port Jackson Fig', common_name: 'Port Jackson Fig', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: 'Location: In front of Dolphin Theatre', identification: 'Large tree. Elliptic blunt pointed leaves 10 cm long, glossy dark green above, rust coloured underneath', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: 'Large tree, 20-30 m, 20-30 m, tree > 12m.', environment: 'water during establishment.', scientific_name: 'Ficus rubiginosa')
CurrentPlant.create(name: 'Prickly  Moses', common_name: 'Prickly  Moses', description: '1 x 1m shrub. Bipinnate leaves not recurved at edges.', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: 'Survives without water. Coastal', scientific_name: 'Acacia pulchella')
 CurrentPlant.create(name: 'Pride of Bolivia', common_name: 'Pride of Bolivia, Tipu tree', description: 'Seed pods are designed for wind dispersal. Throw them up in the air and they spin like a helicopter blade.', synonym: 'Tipuana speciosa', subspecies: '', location_name: 'North of Arts building', general_info: 'Requires well drained soil.', additional_info: '', identification: 'Has racemes of pea-like bright yellow-orange flowers in spring. Has 10 cm winged pods with a single seed at one end (samara) in summer.', physical:'- Attractive, Pinnate 25 cm long, 11-25 oval leaflets, light green foliage.
...
- Salt Tolerant', scientific_name: 'Melaleuca cuticularis') 
 CurrentPlant.create(name: 'Sandplain bottlebrush', common_name: 'Sandplain bottlebrush, Sand bottlebrush', description: 'ornamental medium sized shrub with brilliant red flowers in spring - summer', synonym: '', subspecies: '', location_name: '', general_info: 'found growing on kwongan sandplain and sandy flats', additional_info: 'Commonly known as \'bottlebrush\' due to its dense cylindrical floral spike (also used to describe Callistemon and Calothamnus, note that Callistemon is often known as \'true bottlebrush\'). The prefix of \'Sand\' or \'Sandplain\' describing its native habitat.
...
- Salt Tolerant', scientific_name: 'Banksia prionotes') 
 CurrentPlant.create(name: 'Scarlet banksia', common_name: 'Scarlet banksia, Albany banksia', description: 'Spectacular floral-spikes, quick growing plant, readily succumbing to phytophthora. Widely cultivated.', synonym: '', subspecies: '', location_name: '', general_info: 'Found growing in deep white or grey sand in tall shrubland and in low woodlands.', additional_info: 'Latin coccineus (scarlet) referring to the styles. Type collection from King George Sound, in 1801 by Robert Brown. 
...
- Frost Tolerant', scientific_name: 'Banksia coccinea') 
 CurrentPlant.create(name: 'Sea rush', common_name: 'Sea rush', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: 'Widespread wetland sedge. Covers extensive areas. Tussock 0.8 - 1.5 m high. Stems circular in cross section (2-4 mm) with continuous pith. Few basal leaves, similar to stems with sharp apex. Inflorescence has clusters of 3-15 dark brown flowers, flowers have 6 floral segments.', physical:'- Mostly thin stems, dark green foliage.
...
- Salt Tolerant', scientific_name: 'Juncus karusii (incomplete)') 
 CurrentPlant.create(name: 'Sea-urchin hakea', common_name: 'Sea-urchin hakea', description: 'attractive foliage contrast (blue - green, silvery foliage) and red pin-cushion flowers', synonym: '', subspecies: '', location_name: 'UWA Campus: Sunken Garden
...
Frost Tolerant', scientific_name: 'Hakea petiolaris') 
 CurrentPlant.create(name: 'Showy honey-myrtle', common_name: 'Showy honey-myrtle, Western tea-myrtle', description: 'attractive and long flowering bushy shrub', synonym: '', subspecies: '', location_name: 'UWA Campus: Biological sciences library
...
Salt Tolerant', scientific_name: 'Melaleuca nesophila') 
 CurrentPlant.create(name: 'Silky eremophila', common_name: 'Silky eremophila', description: 'attractive silvery woolly shrub with contrasting pink-lilac flowers in spring', synonym: '', subspecies: '', location_name: '', general_info: 'will grow in light to heavy soil', additional_info: '', identification: 'The bush has a silvery woolly appearance (due to the branches, new growth and leaves all being covered in white hairs). Leaves are greyish, linear to 2cm long. Flowers are lilac, borne in spring.', physical:'- Attractive, linear, grey-, silver foliage.
...
- Prefers all types, well drained soils, with a neutral to acidic pH.', scientific_name: 'Grevillea robusta') 
 CurrentPlant.create(name: 'Silver cassia', common_name: 'Silver cassia, Wormwood senna, Feathery cassia, Desert cassia', description: 'Creates a good foliage contrast in the garden. Yellow buttercup flowers are produced over a long period. Rampant grower - covers areas quickly.
...
- Frost Tolerant', scientific_name: 'Angophora costata') 
 CurrentPlant.create(name: 'Snakebush', common_name: 'Snakebush', description: '', synonym: '', subspecies: '', location_name: 'UWA Campus: Taxonomic Garden', general_info: '', additional_info: 'Extending from Kalbarri south to Albany.', identification: 'Several growth forms of this plant exist, most common is the prostrate or sprawling form.
...
Prefers sand, well drained soils.', scientific_name: 'Hemiandra pungens') 
 CurrentPlant.create(name: 'Spider net grevillea', common_name: 'Spider net grevillea', description: 'long flowering', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: 'Leaves can be either simple linear or 2-3 lobed (2cm long). Flowers are waxy, red, borne terminally in pedulous clusters in winter and spring (sometimes in late autumn)', physical:'- Simple or lobed, green foliage.
...
', description: 'Useful spreading shrub, especially in coastal areas. Grey-green, finely divided foliage provides useful contrast. Good floral display of contrasting red flowers, borne terminally and pendulous.
...
- Prefers well drained soils.', scientific_name: 'Chlorophytum comosum') 
 CurrentPlant.create(name: 'Spiny-headed mat rush', common_name: 'Spiny-headed mat rush', description: 'graceful, arching foliage plant.', synonym: '', subspecies: '', location_name: 'Agriculture Gardens, Western underpass', general_info: 'copes with damp soils (poorly drained areas), tolerates temporary inudation.', additional_info: '', identification: 'Foliage is dark green, narrow, strap-like (tussock/ grass-like), slightly stiff and arching (note leaves have several points at the apex). Creamy, fragrant flowers are borne in spikes in spring to early summer (flower stalk is flattened). Male and female flowers are on separate plants (dioecious).', physical:'- Attractive, narrow, strap-like, dark green foliage.
...
- three drop', scientific_name: 'Banksia littoralis') 
 CurrentPlant.create(name: 'Swamp lily', common_name: 'Swamp lily, River lily', description: 'Large bulbous perennial with a striking rosette of large green leaves. This native blends with exotics.
...
Frost Tolerant', scientific_name: 'Hypocalymma robustum') 
 CurrentPlant.create(name: 'T. \'Paynei\'', common_name: 'T. \'Paynei\'', description: 'Pretty flowering shrub winter/spring.
...
Frost Tolerant', scientific_name: 'Thryptomene saxicola (incomplete)') 
 CurrentPlant.create(name: 'Tar bush', common_name: 'Tar bush, Poverty bush, Emu bush', description: 'Grown for its attractive flowers and silver-grey foliage. Long-flowering
...
- Salt Tolerant', scientific_name: 'Scaevola crassifolia') 
 CurrentPlant.create(name: 'Tree hovea', common_name: 'Tree hovea', description: 'attractive purple pea-shaped flowers produced in spring
...
- two drop', scientific_name: 'Melaleuca leucadendra') 
 CurrentPlant.create(name: 'White Cascade', common_name: 'White Cascade', description: 'Weeping form, profuse flower display', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: 'Woody shrub, flowers white with 5 petals, leaves 2 x 5 mm', physical:'- Attractive, small lanceolate, dark green foliage.
...
- one drop', scientific_name: 'Brachychiton discolour') 
 CurrentPlant.create(name: 'White stemmed wattle', common_name: 'White stemmed wattle', description: '', synonym: '', subspecies: '', location_name: '', general_info: 'Predominantly a coastal species, restricted to limestone areas (spearwood soil).', additional_info: 'xanthos being Greek for \'yellow\' and refers to the flowers.
...
an array of insects and sticky ants (Crematogastersp.) harvest secretions from basal glands at the base of phyllodes. In addition it is thought that ants disperse the seed. The \'drab\' appearance of the seed stalks being unlikely to attract birds. Jewel beetles ( Agrilus australasiae, Cisseis sp. and Melobasis terminata) and two species of small grey long-horned beetle are also found on A. xanthina. Flowering attracting native bees, and in summer parasitic wasps can be seen preying upon moth larvae found growing on the foliage.', architectural_info: '', characteristics: 'bushy, spreading, woody shrub >2m. With a dense canopy.', environment: '', scientific_name: 'Acacia xanthina') 
 CurrentPlant.create(name: 'Wild Iris', common_name: 'Wild Iris', description: 'Grown for their attractive foliage and iris-shaped flowers. Flowers are generally short lived but blooms are regular and successive over spring and early summer.', synonym: '', subspecies: '', location_name: 'Agriculture Gardens', general_info: 'prefers humus rich soil which doesn\'t completely dry out', additional_info: 'Native to southern Africa', identification: 'This clumping plant has long, narrow, tough, erect basal leaves. Branching stems bearing a succession of short-lived (several days) iris-like flowers during summer. Iris-like flowers are large (10cm diameter), predominantly white with attractive mauve and orange-yellow markings on the petals. Cylindrical fruit is seen on floral stems for some time post flowering.
...
CurrentPlant.create(name: 'Wollemi Pine', common_name: 'Wollemi Pine', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Wollemia nobilis')
 CurrentPlant.create(name: 'Woolly orange banksia', common_name: 'Woolly orange banksia', description: 'A very attractive species. Terminal, cylindrical and conspicuous flowering cones. Unopened flowers pale pink and hairy. Orange fowers opening from the base up.
...
- Frost Tolerant', scientific_name: 'Adenanthos sericeus') 
 CurrentPlant.create(name: 'Yellow buttons', common_name: 'Yellow buttons', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'- Attractive, silver foliage.
...
- Frost Tolerant', scientific_name: 'Anigozanthos flavidus') 
 CurrentPlant.create(name: 'Yesterday-today-and-tomorrow', common_name: 'Yesterday-today-and-tomorrow, Brazil raintree', description: 'attractive purple-blue fading to white flowers
...
- Salt Tolerant', scientific_name: 'Astartea fascicularis') 
 CurrentPlant.create(name: '', common_name: '', description: 'Broad prostrate groundcover. Forms a dense leafy carpet. Large scale ground cover. Numerous large conspicuous burgundy-red flowers. \'Sun Kissed Waters\' - variant with very attractive variegated leaves: green/yellow and blood red foliage. Long flowering period. Frost and sun hardy.
...
CurrentPlant.create(name: '', common_name: '', description: 'Compact shrub to 1m high', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: 'Full sun', scientific_name: 'Maireana oppositifolia')
CurrentPlant.create(name: '', common_name: '', description: 'Compact woody shrub. 1 x 1m. Masses of bright red bottle brush flowers. Very hardy.', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: 'Will survive without watering Perth.', scientific_name: 'Callistemon Little John')
CurrentPlant.create(name: '', common_name: '', description: 'Compact woody shrub. Stunning floral display.', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Verticordia')
CurrentPlant.create(name: '', common_name: '', description: 'Dense low spreading shrub. Useful groundcover. Soft grey- green foliage. Flowers insignificant.', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: 'Very hardy coastal gardens. Drought tolerant.', scientific_name: 'Rhagodia  spinescens var deltophylla')
CurrentPlant.create(name: '', common_name: '', description: 'Dense rounded shrub to 1 m. Pink woolly flowers in spring & early summer', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Verticordia monadelpha')
 CurrentPlant.create(name: '', common_name: '', description: 'Dwarf shrub', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '1-1.5m shrub pink surprise
1.5-2m dwarf Apricot', environment: 'Full sun, part shade', scientific_name: 'Nerium oleander cv pink Surprise') 
 CurrentPlant.create(name: '', common_name: '', description: 'Foliage colour, terminal strap-like leaves. Strinking form.', synonym: '', subspecies: '', location_name: '', general_info: 'Prefers fertile, well-drained but water-retentive soil', additional_info: '', identification: 'Tall, evergreen sparsley branched shrub/tree. Strap-like leaves. Inconspicuous yellow-green flowers in late spring.', physical:'- Attractive, terminal, strap-like leaves, light green foliage.
...
Frost Tolerant', scientific_name: 'Banksia gardneri') 
 CurrentPlant.create(name: '', common_name: '', description: 'Grown for its attractive foliage and iris-shaped flowers. Flowers are generally short lived but blooms are regular and successive over spring and early summer.', synonym: '', subspecies: '', location_name: 'Agriculture Garden', general_info: 'Requires humus rich soil which is well drained but doesn\'t dry out completely', additional_info: 'this genus is native to southern Africa', identification: 'This clumping plant has long, narrow, tough, erect basal leaves. Branching stems bearing a succession of short-lived iris-like pale yellow flowers (with a brown patch on each petal) during summer. Cylindrical fruit is then seen on floral stems for some time post flowering.
...
CurrentPlant.create(name: '', common_name: '', description: 'Hairy leaved coastal grass', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: 'Good for stabilizing coastal sand dunes', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: 'Coastal sand dunes', scientific_name: 'Spinifex hirsutus')
CurrentPlant.create(name: '', common_name: '', description: 'Long leaved dune grass', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: 'Good for stabilizing coastal sand dunes', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Spinifex longifolia')
 CurrentPlant.create(name: '', common_name: '', description: 'Popular for its profuse display of blue-purple flowers during the summer months. Flowers are attractive, in umbels and stand out from the foliage on erect stalks. When not in flower the graceful arching strap-like lushious looking leaves provide an attractive exotic look.', synonym: 'A. orientalis', subspecies: 'orientalis', location_name: 'Student Administration gardens', general_info: 'will grow in most soil types', additional_info: 'Originating from southern Africa.', identification: 'Almost evergreen. Strap-shaped leaves are broad, dark green. Produces masses of large dense floral umbels made up of rich blue flowers borne on strong erect stems.', physical:'- Attractive, strappy, arching, dark green foliage.
...
- Prefers sand, well drained soils.', scientific_name: 'Banksia blechnifolia (incomplete)') 
 CurrentPlant.create(name: '', common_name: '', description: 'quick growing, native ground cover', synonym: '', subspecies: '', location_name: '', general_info: 'Growing in deep white sand, in heath or mallee-heath, with an annual rainfall of 350-400mm.', additional_info: 'Petiolaris referring to the long petioles of the leaves. 
...
CurrentPlant.create(name: '', common_name: '', description: 'Shrub 0.1 - 0.6m high. Yellow flowers July to December.', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Hibbertia huegelii')
CurrentPlant.create(name: '', common_name: '', description: 'Small shrub with oval leaves green on top grey underneath with fine hairs. White star flowers with 4 petals in spring.', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '0.5 - 2m tall x 1-2 m', environment: 'Tolerates coastal exposure', scientific_name: 'Correa alba')
 CurrentPlant.create(name: '', common_name: '', description: 'Useful coastal shrub. Pendulous pink hairy flowers', synonym: '', subspecies: '', location_name: 'grown in King\'s Park', general_info: 'favours limestone soils from Dirk Hartog Island to Israelite Bay and Rottnest and Garden Islands.', additional_info: '', identification: 'Spreading open woody shrub. Silver-grey foliage. Flowers pendulous and in clusters of 1-5. Petals pink, hairy with deep puple centres. Stamens 5. Leaves narrow linear up to 60 mm with rolled margins. Two basal leaf-like stipules about half as long as the leaf.', physical:'- Attractive, up to 60mm long, linear with rolled margins., silver foliage.
...
CurrentPlant.create(name: '', common_name: '', description: 'Woody shrub 75cm - 1.5m high. Soft hairy leaves. Red flowers in spring.', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Calothamnus hirsutus')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: '?')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'A')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: 'God for coastal sand dune restoration.', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: 'Coastal dunes, pictue of dunes near Penguin Is Rockingham.', scientific_name: 'Acacia rostellifera')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: 'similar to Acacia littorea which is not found in Perth. A. truncata found at Reabold Hill.', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: 'woody shrub >2m.', environment: '', scientific_name: 'Acacia truncata (incomplete)')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: 'woody shrub >2m.', environment: '', scientific_name: 'Banksia ericifolia')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Carpobrotus')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: 'Tall thin trunk with a rosette of long leaves 10 cm wide x 60 cm long at the tops.', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: 'tall tree-like, woody shrub >2m.', environment: '', scientific_name: 'Cordyline indivisa')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Cycad thouarsi')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Dodonea viscosa purpurea')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Eremophila ?')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Eremophila 2')
 CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: 'tree < 6m.
', environment: '', scientific_name: 'Eucalyptus foecunda') 
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: 'Black cockatoos and other parrots eat nectar & seed', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Eucalyptus Lemanii')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: 'woody shrub 1 - 2 m.', environment: '', scientific_name: 'Eucalyptus tetragona (incomplete)')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Ficus')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Golden Cane Palm')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Grevilea')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Grevillea')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Grevillea')
 CurrentPlant.create(name: '', common_name: '', description: '', synonym: 'banksii x bipinnatifida (incomplete)', subspecies: '', location_name: '', general_info: 'Tolerates a wise range of conditions including acid to alkaline soils.', additional_info: 'Commemorating Charles F. Greville, who was an early president of the Royal Horticultural Society. \'Robyn Gordon\' bred by Gordon.', identification: 'Shrub 1-2 m. Leaves simple, deeply bipinnatisect, 12 cm long and 12 cm wide with 11-15 prongs. Dense terminal raceme 10-15 cm long with 90-100 orange-red flowers. Upper stems are grey and hairy, ribbed below leaf bases.', physical:'Attractive, Leaves simple, deeply bipinnatisect, 12 cm long an, dark green foliage.', horticulture: '- low maintenance required.
...
Wind Tolerant', scientific_name: 'Grevillea nudiflora') 
 CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: 'WA confined to a narrow coastal limestone belt from Jurien Bay to Coolimba', general_info: '', additional_info: '', identification: '', physical:'- Green foliage.
...
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Hake')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Hake')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Hibiscus')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Hypocalyma')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Isopogon')
 CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: 'Found along fresh to brackish watercourses, lakes and seasonally damp areas', additional_info: '', identification: 'Tufted rush <2 m. Stems cylindrical in cross section (2-7mm) with a central pith. Leaves reduced to basal sheaths.Inflorescence 15 cm long.', physical:'- Basal sheaths up to 23 cm long, green foliage.
...
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Leucospermum')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Pandanas')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Pelargonium')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: 'Peak flowering time late Sept/early Oct', environment: '', scientific_name: 'Pimelea')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Plumeria')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Raphiolepis cv Apple Blossum')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Regalia?')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Scaffold aneura')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Swainsona')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Tecoma alata')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Tetragona decumbens')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Unknown 3')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Unknown 3')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Unknown1')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Viburnum?')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Water hyacinth')
CurrentPlant.create(name: '', common_name: '', description: '', synonym: '', subspecies: '', location_name: '', general_info: '', additional_info: '', identification: '', physical:'', horticulture: '', architectural_uses: '', culture: '', conservation: '', wildlife: '', architectural_info: '', characteristics: '', environment: '', scientific_name: 'Yellow Broome')
